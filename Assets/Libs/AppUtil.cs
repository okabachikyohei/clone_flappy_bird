...
public static class AppUtil {
	...
	public static TouchInfo GetTouch()
	{
		...
		{
			if (Input.GetMouseButtonDown(0) || Input.GetKeyDown(KeyCode.Space)) { return TouchInfo.Began; }
			if (Input.GetMouseButton(0)) { return TouchInfo.Moved; }
			if (Input.GetMouseButtonUp(0) || Input.GetKeyDown(KeyCode.Space)) { return TouchInfo.Ended; }
		}
		else
		{
